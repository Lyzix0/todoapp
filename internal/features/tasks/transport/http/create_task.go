...
type CreateTaskRequest struct {
	Title        string  `json:"title" validate:"required,min=1,max=100" example:"Make homework"`
	Description  *string `json:"description" validate:"omitempty,min=1,max=1000" example:"Make until Tuesday"`
	AuthonUserID int     `json:"author_user_id" validate:"required" example:"2"`
}
...
// @Success 201 {object} CreateTaskRequest "Successfully created task"
