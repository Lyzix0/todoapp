...
// GetUsers godoc
// @Summary User list
// @Description View user list with optional pagination
// @Tags users
// @Produce json
// @Param limit query int false "User page size"
// @Param offset query int false "User page offset"
// @Success 200 {object} GetUsersResponse "Successfully get users"
